...
// export const setAvatarAPI = 'http://localhost:8080/api/auth/setAvatar';
// export const registerAPI = 'http://localhost:8080/api/auth/register';
// export const loginAPI = 'http://localhost:8080/login/api/auth/login';
// export const addTransaction = 'http://localhost:8080/api/v1/addTransaction';
// export const getTransactions = 'http://localhost:8080/api/v1/getTransaction';
