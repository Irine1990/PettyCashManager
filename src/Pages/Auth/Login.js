...
const Login = () => {
  ...
  return (
    <div style={{ position: "relative", width: "100%", height: "950px", backgroundColor: "black", overflow: "hidden" }}>
      {/* <Particles
        id="tsparticles"
        init={particlesInit}
      ...
      >
        <Row>
          <Col md={{ span: 6, offset: 3 }}>
            ...
            <h2 className="text-center text-white">Welcome to PettyCash Manager</h2>
